package rs.ac.bg.etf.dm130240d.poligon.settings;
...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        private Preference restorePreferences;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            /*
            restorePreferences = (Preference) findPreference("reset_to_default");
            restorePreferences.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    String pre = sp.getString("otpor", "20");
                    ...
                    Toast.makeText(getActivity(),"OTPOR PRE: " + pre, Toast.LENGTH_SHORT).show();
                    return true;
                }
            });
            */
