...
public class GameView extends ImageView {
	...
	protected Paint currentBallPaint;

	protected void GameViewInit() {
		this.controller = null;

		currentBallPaint = new Paint();
		currentBallPaint.setColor(Color.rgb(0, 0, 255));
	...
	protected void onDraw(Canvas canvas) {
		...
		if(controller.getStartHole().x != 0 && controller.getStartHole().y != 0 && !controller.isGameOver()) {
			canvas.drawCircle(controller.getCurrentBall().x, controller.getCurrentBall().y, 75, currentBallPaint);
		}
